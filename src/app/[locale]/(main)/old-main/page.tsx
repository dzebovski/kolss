...
export default async function OldMainPage() {
        ...
        <FadeIn className="mx-auto w-full max-w-6xl px-4 py-16 md:px-6">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            {featuredItems.map((project) => {
              ...
              const formattedPrice = project.price_start
                ? priceFormatter.format(project.price_start)
                : null;
